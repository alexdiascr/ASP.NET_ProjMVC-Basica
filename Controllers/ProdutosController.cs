...
namespace AppMVCBasica.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        public ProdutosController(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var aplicationDbContext = _context.Produtos.Include(p => p.Fornecedor);
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'AplicationDbContext.Produtos'  is null.");
            }
            var produto = await _context.Produtos.FindAsync(id);
            if (produto != null)
            {
